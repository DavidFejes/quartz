...
**DEFINÍCIÓ:** ==Véletlen jelenség==nek nevezzük azokat a jelenségeket, amelyeket a leírható körülmények nem határoznak meg egyértelmûen. Pl. egy dobókocka feldobása. 
...
**DEFINÍCIÓ:** Az elemi események egy halmazát, azaz az eseménytér egy részhalmazát ==esemény==nek nevezzük. Pl. esemény kockadobásnál páros szám dobása. Az eseményeket nagybetûvel jelöljük. Pl. $A = {2; 4; 6}$ 
...
**DEFINÍCIÓ:** Az $A$ esemény $B$-re vonatkozó ==feltételes valószínűség==e: $P(A \mid B) = \frac{P(A \cdot B)}{P(B)}$.  
