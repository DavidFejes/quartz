...
**DEFINÍCIÓ:** Egy gráfot egyszerû gráfnak nevezünk, ha nincs benne sem hurokél, sem többszörös él.
<p align="center">
...
**DEFINÍCIÓ:** Ha egy gráfnak n pontja van ($n \in\mathbb{Z}^+$) és mindegyik pontból pontosan egy él vezet a többi ponthoz, akkor a gráfot $n$ pontú teljes gráfnak nevezzük. 
...
**DEFINÍCIÓ:** A kör olyan vonal, amelynek kezdõ és végpontja megegyezik és a pontok nem ismétlõdnek. 
...
**TÉTEL:** Nyílt Euler vonala akkor és csak akkor van egy összefüggõ gráfnak, ha pontosan két pá ratlan fokú pontja van.
<p align="center">
