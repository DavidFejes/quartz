...
**DEFINÍCIÓ:** Az ==egész számok== halmaza ($\mathbb{Z}$) a természetes számokból és azok [[Ellentett.md|ellentettjeibõl]] áll. Az egész számok halmaza az összeadáson és a szorzáson kívül a kivonásra nézve is zárt, ugyanakkor az osztás kimutathat a halmazból. Pl. $2x + 3 = 4$ egyenlet megoldása.
...
**BIZONYÍTÁS**: A bizonyítást indirekt módon végezzük, lényege, hogy a bizonyítandó állítás tagadásáról bebizonyítjuk, hogy az hamis. Ez azt jelenti, hogy a bizonyítandó állítás igaz. Tegyük fel hogy $\sqrt{2}$ racionális szám, azaz felírható $a$ $b$ alakban, ahol $a, b \in\mathbb{Z}$, $b \neq 0$, $(a;b) = 1$. ([[III.Osztok#^relativ-primek|relatív prímek]]) 
Ekkor $\sqrt{2} = \frac{a}{b} \implies \; 2=\frac{a^2}{b^2} \implies \; 2*b^2 = a^2$.
Az egyenlet jobb oldalán szereplõ ($a^2$) szám [[Primtenyezos_Felbontas.md|prímtényezõs felbontásában]] a 2 mindenféleképpen páros kitevõn (akár a nulladikon) szerepel, míg a bal oldalon levõ szám ($2 * b^2$) prímtényezõs felbontásában a 2 kitevõje páratlan (legkevesebb 1). Ez azonban lehetetlen, hiszen a [[II.Primszamok_Osszetett_Szamok#^szamelmelet-alaptetele|számelmélet alaptétele]] szerint egy pozitív egész számnak nincs két lényegesen különbözõ felbontása. Tehát nem igaz az indirekt feltevésünk, vagyis igaz az eredeti állítás: $\sqrt{2}$ irracionális. 
**Tulajdonságok:**
...
---
**DEFINÍCIÓ**: A racionális és az irracionális számok halmaza [[II.Halmazmuveletek#^diszjunkt|diszjunkt]] halmazok ($\mathbb{Q} \cap \mathbb{Q}* = \emptyset$), a két halmaz egyesítése a valós számok halmaza: R = Q » Q*. A valós számok halmaza zárt a 4 alapmûveletre.
[Valós számok és részhalmazai](Szamhalmazok.png)